...
export class CoordinatesPage {
   ...
   */
  loadGameSettings() {
    const savedSettings = localStorage.getItem('chessColate_coordinates_gameSettings');
    if (savedSettings) {
   ...
   */
  saveGameSettings() {
    localStorage.setItem('chessColate_coordinates_gameSettings', JSON.stringify(this.gameSettings));
  }
