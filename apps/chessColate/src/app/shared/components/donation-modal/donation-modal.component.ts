...
import { closeOutline, heartOutline, heart } from 'ionicons/icons';
...
addIcons({ closeOutline, heartOutline, heart });
...
export interface DonationOption {
  ...
  label: string;
  description: string;
  packageIdentifier: string; // Identificador del package en RevenueCat
}
  ...
  async loadDonationOptions() {
    try {
      ...
      if (offerings.current) {
        // Filtrar packages de donación (puedes ajustar la lógica según tus identificadores)
