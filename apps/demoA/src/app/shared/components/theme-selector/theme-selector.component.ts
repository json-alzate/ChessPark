...
import { arrowBackOutline, refreshOutline, infiniteOutline, stopOutline } from 'ionicons/icons';
...
export class ThemeSelectorComponent {
    ...
    @Input() showRefreshGoals = false;
    @Output() back = new EventEmitter<void>();
    @Output() simulateLoading = new EventEmitter<void>();
    @Output() stopSimulateLoading = new EventEmitter<void>();
    @Output() refreshGoals = new EventEmitter<void>();

    constructor() {
        addIcons({arrowBackOutline,infiniteOutline,stopOutline,refreshOutline});
    }
